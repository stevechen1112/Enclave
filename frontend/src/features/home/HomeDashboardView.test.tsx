...
const baseModel: HomeDashboardModel = {
  ...
  error: null,
  assets: [],
  stats: { total: 5, ready: 2, processing: 1, review: 1, reviewItems: 8, failed: 1 },
  canUpload: true,
  canReview: true,
  canManage: true,
...
describe('HomeDashboardView', () => {
  ...
  it('does not imply a field application for a Base-only tenant', () => {
    render(<MemoryRouter><HomeDashboardView model={{ ...baseModel, applications: [], canReview: false, canManage: false, stats: { total: 1, ready: 1, processing: 0, review: 0, reviewItems: 0, failed: 0 } }} /></MemoryRouter>)
