...
const proposalLabels: Record<string, string> = {
  ...
  decision_rules: '判斷原則', prohibited_actions: '禁止動作', high_risk: '高風險提醒',
}
