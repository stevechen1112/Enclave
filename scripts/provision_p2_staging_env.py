...
def build_files(
    *,
    ...
    app = [
        ...
        "RATE_LIMIT_GLOBAL_PER_IP=2000",
        "RATE_LIMIT_PER_USER=1000",
        "RATE_LIMIT_PER_TENANT=5000",
        "RATE_LIMIT_CHAT_PER_USER=200",
